...
<html lang="pt-br">
  <head>
    <title>AppIdea &mdash; Dê uma ideia de APP</title>
    <meta charset="utf-8">
          ...
          <div class="container">
            <div class="row align-items-center" style="margin-bottom: -15px;">
              <div class="col-6 col-md-6 col-xl-2  d-block d-lg-none">
                <h1 class="mb-0 site-logo"><img src="/images/logo.png">
              ...
              <div class="col-12 col-md-10 main-menu">
                <nav class="site-navigation position-relative text-right" role="navigation">
                  ...
                  <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                    <li><a href="{{url('/')}}" class="nav-link"><img src="/images/logo.png" style="width=75%;"></a></li>
                    <li><a href="#features-section" class="nav-link">Detalhes</a></li>
                    ...
                    <li><a href="#contact-section" class="nav-link">Sua ideia</a></li>
                  </ul>
                </nav>
              </div>
